...
public class WordPieceTokenizerTests
{
    ...
    {
        var text = "wtf";
        var word = new Word(0, text.Length);

        var tokens = _tokenizer.TokenizeWord(word, text).ToList();
    ...
    // {
    //     var text = "wtf";
    //     var word = new Word(10, text.Length);
    //
    //     var tokens = _tokenizer.TokenizeWord(word, text).ToList();
    //
    //     Assert.Multiple(() =>
    ...
    public async Task TokenizeWord_SingleUNK()
    {
        ...
        var token = _tokenizer.TokenizeWord(word, text).Single();
